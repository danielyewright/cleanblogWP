...
?>
	...
	<footer id="colophon" class="site-footer bg-light">
		<div class="site-info container text-center py-5">
			...
			<span class="sep"> | </span>
				...
				printf( esc_html__( 'Theme: %1$s by %2$s.', 'bootstrapwp' ), 'bootstrapwp', '<a href="https://danielywright.me">Daniely Wright</a>' );
				?>
		</div><!-- .site-info -->
	</footer><!-- #colophon -->
</div><!-- #page -->
